...
wheelPointsPerLevel = 3

-- Gem Atelier
wheelAtelierRotateLesserCost = 125000 / 100
wheelAtelierRotateRegularCost = 250000 / 100
wheelAtelierRotateGreaterCost = 500000 / 100

wheelAtelierRevealLesserCost = 125000 / 100
wheelAtelierRevealRegularCost = 1000000 / 100
wheelAtelierRevealGreaterCost = 6000000 / 100
...
-- NOTE: saveIntervalTimeSeconds: set to 0 to disable
toggleSaveIntervalCleanMap = false
saveIntervalTimeSeconds = 2
...
globalServerSaveTime = "04:59:59"
serverShutdownHour = 5 -- Vaigu custom
...
rateExerciseTrainingSpeed = rateAttackSpeed * 3
